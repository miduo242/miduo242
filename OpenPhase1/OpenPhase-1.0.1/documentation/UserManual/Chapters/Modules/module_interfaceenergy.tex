\section{InterfaceEnergy}
\label{sec:module_interfaceenergy}
...
\node[mybox] (box)
{
  ...
  \begin{description}
  \item[What it does] Calculates the interfacial energy
  \item[Requires] \nameref{sec:module_settings}, \nameref{sec:module_boundaryconditions}
  \item[Header file] InterfaceEnergy.h
...
\end{tikzpicture}
\caption{Call graph for module \nameref{sec:module_interfaceenergy}}
\end{figure}
