\section{InterfaceMobility}
\label{sec:module_interfacemobility}
...
\node[mybox] (box)
{
  ...
  \begin{description}
  \item[What it does] Calculates the interfacial mobility
  \item[Requires] \nameref{sec:module_settings}, \nameref{sec:module_boundaryconditions}
  \item[Header file] InterfaceMobility.h
  \item[Input file] None
  \item[Examples] benchmarks/SingleGrain
  \end{description}
  \end{minipage}
};
...
\end{tikzpicture}
\caption{Call graph for module \nameref{sec:module_interfacemobility}}
\end{figure}
