...
int main(int argc, char *argv[])
{
    ...
    {
       /* // Homogeneous liquid phase starting configuration
        size_t idx1 = Initializations::Single(Phi, 0, BC, OPSettings);
        Phi.FieldsStatistics[idx1].State = AggregateStates::Liquid;
        ...
        Phi.FieldsStatistics[idx2].State = AggregateStates::Solid;
